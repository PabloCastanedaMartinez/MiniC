...
import bipre.frontend.ast.ArbolAbstracto;
import bipre.frontend.ast.NodoAST;
import bipre.frontend.lex.Token;
import bipre.frontend.lex.TokenType;
import bipre.util.VisualizadorArbol;
...
public final class Parser {
    ...
    public boolean analizar() {
        ...
        visualizadorConcreto = new VisualizadorArbol(
                Paths.get("output", "arboles", "arbol_concreto.dot"),
                Paths.get("output", "arboles", "arbol_concreto.png"),
                "minic.frontend.parse.ArbolConcreto",
                new Color(219, 234, 254)
        );
        visualizadorAst = new VisualizadorArbol(
                Paths.get("output", "arboles", "ast.dot"),
                Paths.get("output", "arboles", "ast.png"),
                "AST",
