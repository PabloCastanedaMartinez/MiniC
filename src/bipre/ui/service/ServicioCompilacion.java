...
import bipre.codegen.ErrorGeneracionCodigo;
import bipre.frontend.lex.AnalizadorLexico;
import bipre.frontend.lex.ErrorLexico;
import bipre.frontend.lex.Token;
import bipre.frontend.parse.ErrorSintactico;
import bipre.frontend.parse.Parser;
import bipre.frontend.semantics.AdvertenciaSemantica;
import bipre.frontend.semantics.AnalizadorSemantico;
import bipre.frontend.semantics.ErrorSemantico;
import bipre.pipeline.PipelineCompilacion;
import bipre.runtime.ProveedorEntrada;
import bipre.runtime.ResultadoEjecucion;
import bipre.runtime.SimuladorPrograma;
...
public final class ServicioCompilacion {
    ...
    public ServicioCompilacion(ObservadorProgreso observador, ProveedorEntrada proveedorEntrada) {
    ...
    public ResultadoCompilacionUI compilar(String fuente) {
        ...
        try {
            ...
            bipre.pipeline.ResultadoCompilacion codigo = pipeline.ejecutar();
        ...
        try {
            ...
            ResultadoEjecucion ejecucion = new SimuladorPrograma(proveedorEntrada).ejecutar(parser.getArbolAbstracto().getRaiz());
    ...
    private void agregarDetallesCodigo(StringBuilder detalles, bipre.pipeline.ResultadoCompilacion codigo) {
